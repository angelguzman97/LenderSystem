...
<table class="table table-responsive" style="text-align: center;" id="tblPrestamosTemp">
            ...
            <div class="modal-body">
                ...
                <form id="frmPrestamos" method="post">
                    ...
                    <div class="row">
                        <div class="col-3 me-2" style="text-align: center;">
                            <div class="form-group mt-2">
                                ...
                                <select id="credito" class="form-select" name="credito" style="width: 120px;" onchange="calcularTotal();">
                                    <!-- Se recorre con un foreach. Donde row toma el valor de data-->
                    ...
                    <div class="row">
                        ...
                        <select id="plazo" class="form-select" name="plazo" style="width: 100px;">
                        ...
                        <div class="col-5">
                            <div class="form-group mt-2">
                                ...
                                <input id="fecha_inicio" class="form-control" name="fecha_inicio" value="<?php date_default_timezone_set('America/Mexico_City');
                                                                                                                    ...
                                                                                                                    echo strftime('%d de %B %Y'); ?>"  placeholder="" readonly></input>
                            </div>
                        </div>
                        <div class="col-4">
                                <div class="form-group mt-2">
