...
<ol class="breadcrumb mb-4 bg-light">
    <li class="breadcrumb-item active fw-bolder fs-4" style="color: black;">Clientes</li>
</ol>
<!--Botón de agregar nuevo Cliente-->
<button class="btn btn-primary mb-2" data-toggle="collapse" type="button" onclick="frmCliente();"><i class="fa-solid fa-user-plus"></i></button>
<!--El cuerpo de la tabla está almacenado en una variable con una función de ajax. Vor eso se le colocó un id la tabla-->
<table class="table table-responsive" style="text-align: center;" id="tblClientesTemp">
            ...
            <div class="modal-body">
                ...
                <form id="frmClientes" method="post">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input id="fecharegistro" class="form-control" name="fecharegistro" placeholder="<?php date_default_timezone_set('America/Mexico_City');
                                                                                                            setlocale(LC_TIME, 'es_MX');
                                                                                                            echo strftime('%d de %B %Y'); ?>" disabled></input>
                    </div>
