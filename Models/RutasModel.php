...
class RutasModel extends Query
{
    ...
    private $ruta, $nombre, $clave, $telefono, $id, $estado;
    ...
    public function registrarRutas(string $ruta, string $clave, string $nombre, string $telefono)
    {
        $this->ruta = $ruta;
        $this->clave = $clave;
        $this->nombre = $nombre;
        ...
        if (empty($existe)) {
            ...
            $sql = "INSERT INTO rutas(ruta, clave, nombre, telefono) VALUES(?,?,?,?)";
            ...
            $datos = array($this->ruta, $this->clave, $this->nombre, $this->telefono);
    ...
    public function modificarRutasClave(string $ruta, string $clave, string $nombre, string $telefono, int $id)
     {
         $this->ruta = $ruta;
         $this->clave = $clave;
         $this->nombre = $nombre;
         ...
         $sql = "UPDATE rutas SET ruta = ?, clave = ?, nombre = ?, telefono = ? WHERE id = ?";
 
         //Se crea una variable que contiene el array donde indicamos las variables creadas con los this y esa variable se enviará a la carpeta config/App/Query.php
         $datos = array($this->ruta, $this->clave, $this->nombre, $this->telefono, $this->id);
     ...
     public function modificarRutas(string $ruta, string $nombre, string $telefono, int $id)
     {
         $this->ruta = $ruta;
         $this->nombre = $nombre;
         $this->telefono = $telefono;
         ...
         //Se crea una variable que contiene el array donde indicamos las variables creadas con los this y esa variable se enviará a la carpeta config/App/Query.php
         $datos = array($this->ruta, $this->nombre, $this->telefono, $this->id);
