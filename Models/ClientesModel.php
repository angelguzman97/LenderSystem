...
class ClientesModel extends Query
{
    ...
    public function registrarClientes(string $cliente, string $apellidos, int $edad, string $telefono, string $direccion, string $trabajo, string $img, string $fecharegistro, int $id_ruta){
        ...
        $verificar = "SELECT * FROM clientes WHERE cliente = '$cliente'";
        ...
        if (empty($existe)) {
            ...
            $sql = "INSERT INTO clientes(cliente, apellidos, edad, telefono, direccion, trabajo, foto, fecha_registro, id_ruta) VALUES(?,?,?,?,?,?,?,?,?)";
            ...
            $datos = array($this->cliente, $this->apellidos, $this->edad, $this->telefono, $this->direccion, $this->trabajo, $this->img, $this->fecharegistro, $this->id_ruta);
     ...
     public function modificarClientes(string $cliente, string $apellidos, int $edad, string $telefono, string $direccion, string $trabajo, string $img, string $fecharegistro, int $id_ruta, int $id)
     {
         $this->cliente = $cliente;
         $this->apellidos = $apellidos;
         $this->edad = $edad;
         ...
         $sql = "UPDATE clientes SET cliente = ?, apellidos = ?, edad = ?, telefono = ?, direccion = ?, trabajo = ?, foto = ?, fecha_registro = ? WHERE id_ruta = ? AND id= ?";
 
         //Se crea una variable que contiene el array donde indicamos las variables creadas con los this y esa variable se enviará a la carpeta config/App/Query.php
         $datos = array($this->cliente, $this->apellidos, $this->edad, $this->telefono, $this->direccion, $this->trabajo, $this->img, $this->fecharegistro, $this->id_ruta, $this->id);
